...
class ProgressColumn(ABC):
    ...
    def get_table_column(self) -> Column:
        """Get a tables column, used to build tasks tables."""
...
class Progress(JupyterMixin):
    ...
    Args:
        ...
        expand (bool, optional): Expand tasks tables to fit width. Defaults to False.
    """
    ...
    def make_tasks_table(self, tasks: Iterable[Task]) -> Table:
        """Get a tables to render the Progress display.

        Args:
            tasks (Iterable[Task]): An iterable of Task instances, one per row of the tables.

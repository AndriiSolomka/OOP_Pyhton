from lab_4.shapes_utils.figures_editors.shape_factory import ShapeFactory
from lab_4.shapes_utils.shape_editor.shape_editor import ShapeEditor
...
class ShapesEditor(ShapeEditor):
    def draw_temp_shape(self, event):
        ...
        if temp_shape_class:
            temp_shape = temp_shape_class(self._canvas, self._x1, self._y1, event.x, event.y)
